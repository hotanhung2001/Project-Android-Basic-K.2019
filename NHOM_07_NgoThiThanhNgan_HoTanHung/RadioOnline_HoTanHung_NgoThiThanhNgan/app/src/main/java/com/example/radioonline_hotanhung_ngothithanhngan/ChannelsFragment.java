 ...
 */
public class ChannelsFragment extends Fragment implements ChannelsAdapter.Listener{
    ...
    String link = "https://raw.githubusercontent.com/hotanhung2001/RadioOnline/main/srcChannels.json";
    String linkimage ="https://mytuner.global.ssl.fastly.net/media/radios-150px";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvChannel = view.findViewById(R.id.rvChannel);
...
//        });
    ...
    class JsonArrayDownload extends AsyncTask<String,Void, ArrayList<Employee>> {
        ...
        protected ArrayList<Employee> doInBackground(String... strings) {
            ...
            try {
                ...
                for (int i = 0; i < channel.length(); i++) {
                    ...
                    System.out.println(arrayList.get(i).getUrlChannel());
        ...
        protected void onPostExecute(ArrayList<Employee> employees) {
            ...
            rvChannel.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));
            rvChannel.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayoutManager.VERTICAL));
            rvChannel.setAdapter(channelsAdapter);
        }
    }
}